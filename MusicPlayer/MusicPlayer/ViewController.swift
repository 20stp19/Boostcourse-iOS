...
//  MusicPlayer
//
//  Created by Stephen Park on 2020/07/06.
//  Copyright © 2020 Stephen Park. All rights reserved.
//
...
class ViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    func addPlayPauseButton(){
        ...
        button.setImage(UIImage(named: "button_play"), for:
            UIControl.State.normal)
        button.setImage(UIImage(named: "button_pause"), for:
